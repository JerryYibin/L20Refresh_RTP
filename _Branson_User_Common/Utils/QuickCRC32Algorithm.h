...
#ifndef QUICKCRC32ALGORITHM_H_
#define QUICKCRC32ALGORITHM_H_
...
public:
	QuickCRC32Algorithm();
	virtual ~QuickCRC32Algorithm();
public:
	static unsigned int crc32_ccitt(const void *buf, const unsigned int len);
};

#endif /* QUICKCRC32ALGORITHM_H_ */

...
void SocketReceiver_HMI::ProcessTaskMessage(MESSAGE& message)
{
	...
	case REQ_VALIDATE_PASSCODE:
		...
		break;
	case REQ_READ_WELDRESULTHISTORY_POWER_GRAPH:
		message.msgID = UserInterface::TO_UI_TASK_READ_WELDRESULTHISTORY_POWER_GRAPH;
		break;
	case REQ_READ_WELDRESULTHISTORY_HEIGHT_GRAPH:
		message.msgID = UserInterface::TO_UI_TASK_READ_WELDRESULTHISTORY_HEIGHT_GRAPH;
		break;

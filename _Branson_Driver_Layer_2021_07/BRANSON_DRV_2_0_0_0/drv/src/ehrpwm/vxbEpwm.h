...
typedef struct
    ...
    void *regBase;
    void *regHandle;
    UINT32 tbclk;     // Parameter: PWM Half-Period in CPU clock cycles (Q0)
...
#define AM38XX_PWM_BAR(p)       (((EHRPWMGEN *)vxbDevSoftcGet(p))->regBase)
#define AM38XX_PWM_HANDLE(p)    ((EHRPWMGEN *)vxbDevSoftcGet(p))->regHandle

#define CSR_READ_4(pDev, addr)                          \
        vxbRead32(AM38XX_PWM_HANDLE(pDev), (UINT32 *)((char *)AM38XX_PWM_BAR(pDev) + addr))

#define CSR_WRITE_4(pDev, addr, data)                   \
        vxbWrite32 (AM38XX_PWM_HANDLE(pDev), (UINT32 *)((char *)AM38XX_PWM_BAR(pDev) + addr), data)

#define CSR_READ_2(pDev, addr)                          \
        vxbRead16 (AM38XX_PWM_HANDLE(pDev), (UINT16 *)((char *)AM38XX_PWM_BAR(pDev) + addr))

#define CSR_WRITE_2(pDev, addr, data)                   \
        vxbWrite16 (AM38XX_PWM_HANDLE(pDev), (UINT16 *)((char *)AM38XX_PWM_BAR(pDev) + addr), data)
...
typedef enum epwmCcCmpLoadMode
    ...
    EPWM_CC_CMP_LOAD_MODE_CNT_EQ_ZERO_OR_PRD    = PWMSS_EPWM_CMPCTL_LOADAMODE_CTR_0_OR_PRD,

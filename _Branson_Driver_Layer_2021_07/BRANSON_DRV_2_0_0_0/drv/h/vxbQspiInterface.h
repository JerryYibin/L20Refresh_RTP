...
#ifndef VXBQSPIINTERFACE_H_
#define VXBQSPIINTERFACE_H_
 ...
 *              SPI_control().
 */
typedef int32_t (*SPI_ControlFxn)(SPI_Handle handle, uint32_t cmd,
		const void *arg);
 ...
 *              SPI_open().
 */
typedef SPI_Handle (*SPI_OpenFxn)(VXB_DEV_ID pDev, SPI_Handle handle,
...
typedef SPI_Config SPI_config_list[1];
